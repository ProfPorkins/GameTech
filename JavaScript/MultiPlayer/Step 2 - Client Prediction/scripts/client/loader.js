...
Demo.loader = (function() {
    ...
    let scriptOrder = [
        {
            scripts: ['Utilities/Math', 'Utilities/Random', 'Utilities/Queue'],
            ...
            scripts: ['Components/Text', 'Components/Sprite'],
            message: 'Core Components loaded',
            onComplete: null
        }, {
            scripts: ['Components/SpaceShip'],
            message: 'SpaceShip Component loaded',
            onComplete: null
        }, {
